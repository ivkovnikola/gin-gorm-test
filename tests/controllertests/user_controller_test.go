...
import (
	...
	"github.com/ivkovnikola/testgormgin/api/models"
...
func TestCreateUser(t *testing.T) {
	...
	samples := []struct {
		...
		{
			inputJSON:    `{"nickname":"Test", "email": "test@gmail.com", "password": "password"}`,
			statusCode:   201,
			nickname:     "Pet",
		...
		{
			inputJSON:    `{"nickname":"Test1", "email": "test@gmail.com", "password": "password"}`,
			statusCode:   500,
			errorMessage: "Email Already Taken",
		},
		{
			inputJSON:    `{"nickname":"Test", "email": "test1@gmail.com", "password": "password"}`,
			statusCode:   500,
			errorMessage: "Nickname Already Taken",
		},
		{
			inputJSON:    `{"nickname":"test2", "email": "test.com", "password": "password"}`,
			statusCode:   422,
			errorMessage: "Invalid Email",
		},
		{
			inputJSON:    `{"nickname": "", "email": "test3@gmail.com", "password": "password"}`,
			statusCode:   422,
			errorMessage: "Required Nickname",
		},
		{
			inputJSON:    `{"nickname": "test4", "email": "", "password": "password"}`,
			statusCode:   422,
			errorMessage: "Required Email",
		},
		{
			inputJSON:    `{"nickname": "test5", "email": "test4@gmail.com", "password": ""}`,
			statusCode:   422,
...
func TestUpdateUser(t *testing.T) {
	...
	samples := []struct {
	...
	}{
		{
			...
			updateJSON:     `{"nickname":"Test", "email": "test@gmail.com", "password": "password"}`,
			statusCode:     200,
			updateNickname: "Test1",
		...
		},
		{
			...
			id:           strconv.Itoa(int(AuthID)),
			updateJSON:   `{"nickname":"test2", "email": "test2@gmail.com", "password": ""}`,
			statusCode:   422,
			tokenGiven:   tokenString,
			errorMessage: "Required Password",
		},
		{
			...
			id:           strconv.Itoa(int(AuthID)),
			updateJSON:   `{"nickname":"Test3", "email": "test3@gmail.com", "password": "password"}`,
			statusCode:   401,
			tokenGiven:   "",
		...
		},
		{
			...
			id:           strconv.Itoa(int(AuthID)),
			updateJSON:   `{"nickname":"Test4", "email": "test4@gmail.com", "password": "password"}`,
			statusCode:   401,
			tokenGiven:   "This is incorrect token",
			errorMessage: "Unauthorized",
		},
		{
			// "test@gmail.com" belongs to test user
			id:           strconv.Itoa(int(AuthID)),
			updateJSON:   `{"nickname":"Test5", "email": "test@gmail.com", "password": "password"}`,
			statusCode:   500,
			tokenGiven:   tokenString,
			errorMessage: "Email Already Taken",
		},
		{
			// nickname exits
			id:           strconv.Itoa(int(AuthID)),
			updateJSON:   `{"nickname":"Test", "email": "test7@gmail.com", "password": "password"}`,
			statusCode:   500,
			tokenGiven:   tokenString,
			errorMessage: "Nickname Already Taken",
		},
		{
			id:           strconv.Itoa(int(AuthID)),
			updateJSON:   `{"nickname":"Test6", "email": "test8.com", "password": "password"}`,
			statusCode:   422,
			tokenGiven:   tokenString,
			errorMessage: "Invalid Email",
		},
		...
		{
			id:           strconv.Itoa(int(AuthID)),
			updateJSON:   `{"nickname": "Test", "email": "", "password": "password"}`,
			statusCode:   422,
			tokenGiven:   tokenString,
			errorMessage: "Required Email",
		},
