...
func TestLogin(t *testing.T) {
	...
	samples := []struct {
		...
		{
			inputJSON:    `{"email": "test@gmail.com", "password": "password"}`,
			statusCode:   200,
			errorMessage: "",
		},
		{
		...
		{
			inputJSON:    `{"email": "test1@gmail.com", "password": "password"}`,
			statusCode:   422,
			errorMessage: "Incorrect Details",
		},
		{
			inputJSON:    `{"email": "test.com", "password": "password"}`,
			statusCode:   422,
		...
		{
			inputJSON:    `{"email": "test4@gmail.com", "password": ""}`,
			statusCode:   422,
